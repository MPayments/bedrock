...
const workspaceProjects = [
  ...
  unitProject("dimensions", "packages/bedrock/registers/tests/**/*.test.ts"),
  unitProject("documents", "packages/bedrock/documents/tests/**/*.test.ts"),
  unitProject("idempotency", "packages/bedrock/operations/tests/**/*.test.ts"),
  unitProject("ledger", "packages/bedrock/ledger/tests/**/*.test.ts"),
  unitProject("counterparty-accounts", "packages/domains/counterparties/tests/counterparty-accounts/**/*.test.ts"),
  unitProject("reconciliation", "packages/bedrock/reconciliation/tests/**/*.test.ts"),
  ...
  integrationProject("accounting:integration", "packages/bedrock/accounting/tests/integration/**/*.test.ts"),
  integrationProject("balances:integration", "packages/bedrock/balances/tests/integration/**/*.test.ts"),
  ...
  integrationProject("ledger:integration", "packages/bedrock/ledger/tests/integration/**/*.test.ts"),
  integrationProject("reconciliation:integration", "packages/bedrock/reconciliation/tests/integration/**/*.test.ts"),
];

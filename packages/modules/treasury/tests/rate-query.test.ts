...
function createHarness() {
    ...
    const getLatestRate = new GetLatestRateQuery(() => new Date(), currenciesService as any, {
    ...
    const getCrossRate = new GetCrossRateQuery(getLatestRate.execute.bind(getLatestRate));

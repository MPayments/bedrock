...
import { type RateSourceProvider } from "../../src/providers";
...
function createTreasuryTestServiceWithProvider(provider: RateSourceProvider) {
...
describe("Treasury rates integration", () => {

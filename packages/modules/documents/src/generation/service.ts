...
export interface DocumentGenerationServiceDeps {
...
export function createDocumentGenerationService(
  deps: DocumentGenerationServiceDeps,
) {
...
export type DocumentGenerationService = ReturnType<
  typeof createDocumentGenerationService
>;

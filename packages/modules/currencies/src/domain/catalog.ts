...
export const KNOWN_CURRENCY_CODES: ReadonlySet<string> = new Set(
  LIST_CURRENCIES.map((currency) => currency.code),
);

const currencyByCode = new Map<string, (typeof LIST_CURRENCIES)[number]>(
  LIST_CURRENCIES.map((currency) => [currency.code, currency]),
);

      ...
      this.idempotency.withIdempotencyTx({
        ...
        request: {
          ...
          grossRevenueInBaseMinor:
            validated.grossRevenueInBaseMinor ?? null,
          expenseAmountInBaseMinor:
            validated.expenseAmountInBaseMinor ?? null,
          passThroughAmountInBaseMinor:
            validated.passThroughAmountInBaseMinor ?? null,
          netMarginInBaseMinor: validated.netMarginInBaseMinor ?? null,
          ...
          financialLines:
            validated.financialLines?.map((line) => ({
              ...
              inputFixedAmountMinor: line.inputFixedAmountMinor ?? null,
              inputManualAmountMinor: line.inputManualAmountMinor ?? null,

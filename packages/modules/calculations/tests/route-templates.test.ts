...
import { createPaymentRoutesService } from "../src/route-templates/application";
import {
  PaymentRouteCalculationSchema,
  PaymentRouteCalculationFeeSchema,
  type PaymentRouteCalculation,
} from "../src/route-templates/application/contracts/dto";
import {
...
} from "../src/route-templates/application/contracts/zod";
import type {
  PaymentRouteTemplateRecord,
  PaymentRouteTemplatesRepository,
} from "../src/route-templates/application/ports/payment-routes.repository";
...
function createService() {
  ...
  const service = createPaymentRoutesService({
    ...
    runtime: createModuleRuntime({
      ...
      now: () => now,
      service: "calculations.route-templates.test",
    }),

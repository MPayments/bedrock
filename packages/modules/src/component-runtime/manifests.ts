import {
  BEDROCK_PLATFORM_COMPONENT_MANIFESTS,
  type ComponentManifest,
} from "@bedrock/platform/component-runtime";

export const BEDROCK_MODULE_COMPONENT_MANIFESTS = [
  {
...
export const BEDROCK_COMPONENT_MANIFESTS = [
  ...BEDROCK_PLATFORM_COMPONENT_MANIFESTS,
  ...BEDROCK_MODULE_COMPONENT_MANIFESTS,
] as const satisfies ComponentManifest[];

export type BedrockModuleComponentId =
  (typeof BEDROCK_MODULE_COMPONENT_MANIFESTS)[number]["id"];

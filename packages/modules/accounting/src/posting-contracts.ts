export const ACCOUNTING_SOURCE_ID = {
  ...
  PAYMENT_ORDER_INITIATE: "payment_order_initiate",
  PAYMENT_ORDER_SETTLE: "payment_order_settle",
  PAYMENT_ORDER_VOID: "payment_order_void",
...
export const OPERATION_CODE = {
  ...
  COMMERCIAL_INCOMING_INVOICE_OPEN: "COMMERCIAL_INCOMING_INVOICE_OPEN",
  COMMERCIAL_PAYMENT_ORDER_INITIATE: "COMMERCIAL_PAYMENT_ORDER_INITIATE",
  COMMERCIAL_PAYMENT_ORDER_SETTLE: "COMMERCIAL_PAYMENT_ORDER_SETTLE",
  COMMERCIAL_PAYMENT_ORDER_VOID: "COMMERCIAL_PAYMENT_ORDER_VOID",
  COMMERCIAL_OUTGOING_INVOICE_OPEN: "COMMERCIAL_OUTGOING_INVOICE_OPEN",
} as const;
...
export const POSTING_TEMPLATE_KEY = {
  ...
  COMMERCIAL_INCOMING_INVOICE_OPEN: "commercial.incoming_invoice.open",
  COMMERCIAL_OUTGOING_INVOICE_OPEN: "commercial.outgoing_invoice.open",
  COMMERCIAL_PAYMENT_ORDER_AP_CLEAR: "commercial.payment_order.ap_clear",
  ...
  PAYMENT_PAYOUT_IMMEDIATE: "payment.payout.immediate",

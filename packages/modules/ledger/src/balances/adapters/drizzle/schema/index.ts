...
export type BalancePositionRow = typeof balancePositions.$inferSelect;
export type BalanceHoldRow = typeof balanceHolds.$inferSelect;
export type BalanceEventRow = typeof balanceEvents.$inferSelect;
export type BalanceProjectorCursorRow =
...
export const schema = {
  ...
  balancePositions: typeof balancePositions;
  balanceHolds: typeof balanceHolds;
  balanceEvents: typeof balanceEvents;
  balanceProjectorCursors: typeof balanceProjectorCursors;
};

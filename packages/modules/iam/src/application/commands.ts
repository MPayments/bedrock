...
import type { IamServiceContext } from "./shared/context";

export function createCreateUserHandler(context: IamServiceContext) {
...
export function createUpdateUserHandler(context: IamServiceContext) {
...
export function createChangePasswordHandler(context: IamServiceContext) {
  const { identityQueries, identityCommands, passwordHasher, log } = context;
...
export function createChangeOwnPasswordHandler(context: IamServiceContext) {
  const { identityQueries, identityCommands, passwordHasher, log } = context;
...
export function createBanUserHandler(context: IamServiceContext) {
  const { identityQueries, identityCommands, log } = context;
...
export function createUnbanUserHandler(context: IamServiceContext) {
  const { identityQueries, identityCommands, log } = context;

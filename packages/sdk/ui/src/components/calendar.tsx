...
import { Button, buttonVariants } from "@multihansa/ui/components/button"
  ...
  return (
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }: React.SVGProps<SVGSVGElement> & { className?: string; orientation?: "left" | "right" | "up" | "down"; size?: number }) => {
          if (orientation === "left") {
            return (

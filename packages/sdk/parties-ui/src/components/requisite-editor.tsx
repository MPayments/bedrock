...
export type RequisiteEditorProps = {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <span
          className={
            selectedOption || fallbackLabel || value
              ? "truncate"
...
export function RequisiteEditor({
  ...
  useEffect(() => {
    ...
    if (!ownerOptions.some((option) => option.id === ownerId)) {
              ...
              <Field className="md:col-span-2">
                <div className="flex items-center gap-3 rounded-md border px-3 py-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <FieldDescription>
                      Для выбранного владельца и валюты будет сохранён один
                      дефолтный реквизит.
                    </FieldDescription>
                  </div>
                </div>
            ...
            <FieldSet>
              <FieldGroup className="grid gap-4 md:grid-cols-2">
                ...
                <Field>
                  ...
                  />
                  <FieldDescription>
                    Необязательно. Используется, если routing принадлежит
                    конкретному филиалу.
                  </FieldDescription>
                </Field>
              </FieldGroup>

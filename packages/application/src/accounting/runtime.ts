...
import type {
  ...
  ValueBinding,
} from "@bedrock/application/accounting/packs/schema";
import { type PostingTemplateKey } from "@bedrock/application/accounting/posting-contracts";
import { schema } from "@bedrock/application/accounting/schema";
import { assertBooksBelongToInternalLedgerCounterparties } from "@bedrock/application/counterparties";

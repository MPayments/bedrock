import type { BedrockWorkerDescriptor } from "./types";
...
function validateDescriptors(
  descriptors: readonly BedrockWorkerDescriptor[],
): readonly BedrockWorkerDescriptor[] {
...
export function defineWorkerDescriptor<T extends BedrockWorkerDescriptor>(
  input: T,
): T {

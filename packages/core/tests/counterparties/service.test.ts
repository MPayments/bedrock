...
vi.mock("../../src/counterparties/internal/default-book", () => {
  return {
...
vi.mock("../../src/counterparties/internal/group-rules", () => {
  return groupRulesMocks;
});

vi.mock("../../src/counterparties/internal-ledger", () => {
  return internalLedgerMocks;
});

import { createCounterpartiesService } from "../../src/counterparties/service";

...
export type CounterpartyAccount = typeof counterpartyAccounts.$inferSelect;
export type CounterpartyAccountInsert = typeof counterpartyAccounts.$inferInsert;

export const counterpartyAccounts = pgTable(
  "counterparty_accounts",
  {
    ...
    accountProviderId: uuid("account_provider_id")
      .notNull()
      .references(() => counterpartyAccountProviders.id),
  ...
  (t) => [
    uniqueIndex("counterparty_accounts_counterparty_stable_uq").on(
      t.counterpartyId,
      t.stableKey,
    ),

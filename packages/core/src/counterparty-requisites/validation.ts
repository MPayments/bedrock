...
export type CounterpartyRequisiteFieldsInput = RequisiteFieldsInput;

export function validateCounterpartyRequisiteFields(
  input: CounterpartyRequisiteFieldsInput,
) {
...
export function buildCounterpartyRequisiteOptionLabel(input: {
  label: string;
  currencyCode?: string | null;
} & CounterpartyRequisiteFieldsInput) {

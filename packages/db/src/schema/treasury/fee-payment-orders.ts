...
export const feePaymentOrders = pgTable(
  "fee_payment_orders",
  {
    ...
    reserveOperationId: uuid("reserve_operation_id").references(
      () => ledgerOperations.id,
      {
        onDelete: "set null",
      },
    ),
    initiateOperationId: uuid("initiate_operation_id").references(
      () => ledgerOperations.id,
      {
        onDelete: "set null",
      },
    ),
    resolveOperationId: uuid("resolve_operation_id").references(
      () => ledgerOperations.id,
      {
        onDelete: "set null",
      },

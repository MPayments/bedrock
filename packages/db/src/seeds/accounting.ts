...
const ACCOUNT_DIMENSION_POLICIES = [
  // BANK
  ["1110", "counterpartyAccountId", "required"],
  ...
  ["2110", "counterpartyAccountId", "forbidden"],
  ...
  ["2210", "counterpartyAccountId", "forbidden"],
  ...
  ["3110", "counterpartyAccountId", "forbidden"],
  ...
  ["3120", "counterpartyAccountId", "forbidden"],
...
const POSTING_CODE_DIMENSION_POLICIES = [
  ["TR.INTRA.IMMEDIATE", "counterpartyAccountId", true, "line"],
  ["TR.INTRA.PENDING", "counterpartyAccountId", true, "line"],
  ["TR.CROSS.SOURCE.IMMEDIATE", "counterpartyId", true, "debit"],
  ["TR.CROSS.SOURCE.IMMEDIATE", "counterpartyAccountId", true, "credit"],
  ["TR.CROSS.DEST.IMMEDIATE", "counterpartyId", true, "credit"],
  ["TR.CROSS.DEST.IMMEDIATE", "counterpartyAccountId", true, "debit"],
  ["TR.CROSS.SOURCE.PENDING", "counterpartyId", true, "debit"],
  ["TR.CROSS.SOURCE.PENDING", "counterpartyAccountId", true, "credit"],
  ["TR.CROSS.DEST.PENDING", "counterpartyId", true, "credit"],
  ["TR.CROSS.DEST.PENDING", "counterpartyAccountId", true, "debit"],
  ["TC.1001", "customerId", true, "credit"],
  ["TC.1001", "counterpartyAccountId", true, "debit"],
  ["TC.9001", "counterpartyAccountId", true, "debit"],
  ["TC.9001", "counterpartyId", true, "credit"],
  ["TC.9002", "counterpartyAccountId", true, "debit"],
  ["TC.9002", "counterpartyId", true, "credit"],
  ["TC.9003", "counterpartyAccountId", true, "debit"],
  ["TC.9003", "counterpartyId", true, "credit"],
  ["TC.9004", "counterpartyAccountId", true, "debit"],
  ["TC.9004", "customerId", true, "credit"],
  ["TC.9005", "counterpartyAccountId", true, "debit"],
  ...
  ["TC.3011", "counterpartyAccountId", true, "credit"],
  ["TC.3101", "orderId", true, "debit"],
  ["TC.3101", "counterpartyAccountId", true, "credit"],

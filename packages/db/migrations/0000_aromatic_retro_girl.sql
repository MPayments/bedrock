...
CREATE TABLE "counterparty_accounts" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"counterparty_id" uuid NOT NULL,
	"ledger_entity_counterparty_id" uuid NOT NULL,
...
ALTER TABLE "counterparty_accounts" ADD CONSTRAINT "counterparty_accounts_ledger_entity_counterparty_id_counterparties_id_fk" FOREIGN KEY ("ledger_entity_counterparty_id") REFERENCES "public"."counterparties"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "books" ADD CONSTRAINT "books_counterparty_id_counterparties_id_fk" FOREIGN KEY ("counterparty_id") REFERENCES "public"."counterparties"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "counterparty_accounts_ledger_entity_idx" ON "counterparty_accounts" USING btree ("ledger_entity_counterparty_id");--> statement-breakpoint
...
CREATE UNIQUE INDEX "books_default_owner_uq" ON "books" USING btree ("counterparty_id") WHERE "books"."is_default" = true;--> statement-breakpoint

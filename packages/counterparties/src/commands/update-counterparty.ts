    ...
    return async function updateCounterparty(
        ...
        return db.transaction(async (tx) => {
            ...
            let nextGroupIds = validated.groupIds
                ...
                : currentGroupIds;
            const nextCustomerId = validated.customerId !== undefined
            ...
            const membershipChanged = currentGroupIds.length !== nextGroupIds.length
            ...
            if (validated.customerId !== undefined) fields.customerId = validated.customerId;

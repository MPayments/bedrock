...
export const rawPackDefinition = AccountingPackDefinitionSchema.parse({
  ...
  templates: [
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.TRANSFER],
    ...
    pendingTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.TRANSFER_SETTLE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
      requiredRefs: [
        "transferDocumentId",
    ...
    pendingTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.TRANSFER_VOID],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
      requiredRefs: [
        "transferDocumentId",
    ...
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.EXTERNAL_FUNDING],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
    ...
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.PAYIN_FUNDING],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
    ...
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.FX_EXECUTE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
    ...
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.PAYOUT_INITIATE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
    ...
    pendingTemplate({
      ...
      lineType: "post_pending",
      allowModules: [DOCUMENT_MODULE_ID.PAYOUT_SETTLE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
    ...
    pendingTemplate({
      ...
      lineType: "void_pending",
      allowModules: [DOCUMENT_MODULE_ID.PAYOUT_VOID],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
      requiredRefs: ["orderId", "railRef"],
    }),
    createTemplate({
      ...
      allowModules: [DOCUMENT_MODULE_ID.FEE_PAYOUT_INITIATE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [
        "feeBucket",
        "orderId",
    ...
    pendingTemplate({
      ...
      lineType: "post_pending",
      allowModules: [DOCUMENT_MODULE_ID.FEE_PAYOUT_SETTLE],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
    ...
    pendingTemplate({
      ...
      lineType: "void_pending",
      allowModules: [DOCUMENT_MODULE_ID.FEE_PAYOUT_VOID],
      requiredBookRefs: [BOOK_REF_BOOK_ID],
      requiredDimensions: [],
      requiredRefs: ["feePayoutInitiateDocumentId", "railRef"],
    }),

...
export function buildAutoCrossTrace(input: QuoteInput & { mode: "auto_cross"; anchor?: string }, rateNum: bigint, rateDen: bigint) {
    return {
        version: "v1",
        mode: "auto_cross",
...
export function computeExplicitRouteLegs(input: QuoteInput & { mode: "explicit_route" }): ComputedLeg[] {

...
import type { CustomersServiceContext } from "../context";
import { CustomerNotFoundError } from "../errors";
import { ensureCustomerGroupForCustomer } from "../group-rules";
import {
...
export function createUpdateCustomerHandler(
    ...
    return async function updateCustomer(
        ...
        return db.transaction(async (tx) => {
            ...
            let row: Customer = existing as Customer;

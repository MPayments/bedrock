...
export interface AccountingService extends AccountingRuntime {
  listTemplateAccounts(): ReturnType<typeof listTemplateAccounts>;
  listCorrespondenceRules(): ReturnType<typeof listCorrespondenceRules>;
  replaceCorrespondenceRules(
    input: ReplaceCorrespondenceRulesInput,
  ): ReturnType<typeof replaceCorrespondenceRules>;
  validatePostingMatrix(): ReturnType<typeof validatePostingMatrix>;
}

export async function listTemplateAccounts(db: AccountingServiceDeps["db"]) {
  return db
    .select()
...
export async function listCorrespondenceRules(db: AccountingServiceDeps["db"]) {
  return db
    .select()
...
export async function replaceCorrespondenceRules(
  db: AccountingServiceDeps["db"],
  input: ReplaceCorrespondenceRulesInput,
) {
...
export async function validatePostingMatrix(db: AccountingServiceDeps["db"]) {

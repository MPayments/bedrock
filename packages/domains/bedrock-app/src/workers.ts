...
import { createIfrsPeriodCloseWorkerDefinition } from "@bedrock/ifrs-documents";
...
import { BEDROCK_MODULE_MANIFESTS } from "./module-runtime";
...
export function createBedrockWorkerImplementations(input: {
  db: Database;
  logger: Logger;
  moduleRuntime: ModuleRuntimeService;
  tb: TbClient;

export const IDEMPOTENCY_SCOPE = {
  ...
  CONNECTORS_CREATE_INTENT: "connectors.createIntent",
  CONNECTORS_ENQUEUE_ATTEMPT: "connectors.enqueueAttempt",
  CONNECTORS_RECORD_ATTEMPT_STATUS: "connectors.recordAttemptStatus",
  CONNECTORS_HANDLE_WEBHOOK: "connectors.handleWebhook",
  CONNECTORS_INGEST_STATEMENTS: "connectors.ingestStatements",
  CONNECTORS_MARK_INTENT_TERMINAL: "connectors.markIntentTerminal",
  ORCHESTRATION_ROUTE: "orchestration.route",
  ORCHESTRATION_RETRY_SCHEDULE: "orchestration.retrySchedule",

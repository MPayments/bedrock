  ...
  it("reuses the loaded bundle and only projects editable anchor fields into the profile", () => {
    const payload = buildOrganizationLegalEntityPayload(
      ...
      },
      {
        ...
        addresses: [{ id: "addr-1", label: null, countryCode: "DE", postalCode: null, city: "Berlin", line1: null, line2: null, rawText: "Berlin", isPrimary: true, partyLegalProfileId: "profile-1", createdAt: "2026-04-01T00:00:00.000Z", updatedAt: "2026-04-01T00:00:00.000Z" }],
        contacts: [],
        representatives: [],
        licenses: [],
      },

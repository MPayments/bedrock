...
type OrganizationRequisitesPageContentProps = {
  organizationId: string;
};

export async function OrganizationRequisitesPageContent({
  organizationId,
}: OrganizationRequisitesPageContentProps) {
  const requisites = await getOrganizationRequisitesForOrganization(organizationId);
            ...
            render={
              <Link
                href={{
                  ...
                  query: { ownerType: "organization", ownerId: organizationId },
                }}
              />
            }
          >

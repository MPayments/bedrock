...
function resolvePortalCustomerDescription(customer: PortalCustomerContext) {
  return customer.customer.description;
}

function resolvePortalCustomerExternalRef(customer: PortalCustomerContext) {
...
function resolvePortalCounterpartyPhone(
...
export default function PortalCustomersPage() {
  ...
  useEffect(() => {
    async function fetchPortalCustomers() {
      try {

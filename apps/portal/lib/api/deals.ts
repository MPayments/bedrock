...
export async function requestPortalDealProjections(input?: {
  ...
  const response = await fetch(
    `${API_BASE_URL}/portal/deals/projections?${params.toString()}`,
    {
      credentials: "include",
    },
  );
...
export async function requestPortalDealProjection(id: string) {
  const response = await fetch(`${API_BASE_URL}/portal/deals/${id}/projection`, {
    credentials: "include",
  });
...
export async function requestPortalDealDetail(id: string) {
  const response = await fetch(`${API_BASE_URL}/portal/deals/${id}`, {
    credentials: "include",
  });
...
export async function uploadPortalDealAttachment(input: {
  ...
  const response = await fetch(
    `${API_BASE_URL}/portal/deals/${input.dealId}/attachments`,
    {
      body: formData,
      credentials: "include",
      method: "POST",
...
export function buildPortalDealAttachmentDownloadUrl(input: {
  ...
  return `${API_BASE_URL}/portal/deals/${input.dealId}/attachments/${input.attachmentId}/download`;
}
...
export async function deletePortalDealAttachment(input: {
  ...
  const response = await fetch(
    `${API_BASE_URL}/portal/deals/${input.dealId}/attachments/${input.attachmentId}`,
    {
      credentials: "include",
      method: "DELETE",
    },
...
export async function createPortalDealDraft(input: CreatePortalDealDraftInput) {
  const response = await fetch(`${API_BASE_URL}/portal/deals/drafts`, {
    method: "POST",
    credentials: "include",
    headers: {

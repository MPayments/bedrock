...
export type CounterpartyInnLookupResult = {
  address?: string;
...
export type CounterpartyCardParseResult = CounterpartyInnLookupResult & {
  account?: string;
  bankAddress?: string;
  bankCountry?: string;
  bankName?: string;
...
export async function lookupCounterpartyByInn(
  inn: string,
): Promise<CounterpartyInnLookupResult> {
  ...
  return pickStringFields<CounterpartyInnLookupResult>(payload, INN_LOOKUP_FIELDS);
}

export async function parseCounterpartyCardPdf(
  file: File,
): Promise<CounterpartyCardParseResult> {
  ...
  return pickStringFields<CounterpartyCardParseResult>(payload, CARD_PARSE_FIELDS);
}

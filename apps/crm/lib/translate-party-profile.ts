...
type TranslatePartyProfileOptions = {
  onlyEmpty?: boolean;
};
...
type CounterpartyGeneralTranslatable = {
  shortName: string;
  shortNameEn: string;
  fullName: string;
  fullNameEn: string;
...
type TranslateCounterpartyResult = {
...
type OrganizationGeneralTranslatable = {
  shortName: string;
  shortNameEn: string;
  fullName: string;
  fullNameEn: string;
...
type TranslateOrganizationResult = {

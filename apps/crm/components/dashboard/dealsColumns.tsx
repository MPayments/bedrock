...
const STATUS_DISPLAY: Record<DealStatus, { label: string; colorClass: string }> = {
  ...
  pricing: { label: "Маршрут и расчет", colorClass: "bg-indigo-100 text-indigo-800" },
  quoted: { label: "Расчет предложен", colorClass: "bg-sky-100 text-sky-800" },
  awaiting_customer_approval: {
    label: "Ожидание одобрения клиента",
    colorClass: "bg-amber-100 text-amber-800",
  },
  awaiting_internal_approval: {
    label: "Ожидание внутреннего одобрения",
    colorClass: "bg-amber-100 text-amber-800",
  },
  approved_for_execution: {
    label: "Одобрена к исполнению",
    colorClass: "bg-emerald-100 text-emerald-800",
  },
  executing: { label: "В исполнении", colorClass: "bg-blue-100 text-blue-800" },
  partially_executed: {
    label: "Частично исполнена",
    colorClass: "bg-blue-100 text-blue-800",
  },
  executed: { label: "Исполнена", colorClass: "bg-emerald-100 text-emerald-800" },
  reconciling: { label: "Сверка", colorClass: "bg-cyan-100 text-cyan-800" },
  closed: { label: "Закрыта", colorClass: "bg-green-100 text-green-800" },
  expired: { label: "Истекла", colorClass: "bg-zinc-100 text-zinc-700" },
  failed: { label: "Ошибка", colorClass: "bg-rose-100 text-rose-800" },

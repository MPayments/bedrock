...
const TransferOrderResponseSchema = z.object({
  ...
  destinationAccountLabel: z.string().nullable(),
...
function toTransferDto(transfer: any) {
  return {
    ...
    sourceAccountLabel: transfer.sourceAccountLabel ?? null,
    destinationAccountLabel: transfer.destinationAccountLabel ?? null,

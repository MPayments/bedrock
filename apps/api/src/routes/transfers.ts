...
const TransferOrderResponseSchema = z.object({
  ...
  sourceCounterpartyName: z.string().nullable(),
  destinationCounterpartyName: z.string().nullable(),
  sourceOperationalAccountLabel: z.string().nullable(),
  destinationOperationalAccountLabel: z.string().nullable(),
...
function toTransferDto(transfer: any) {
  return {
    ...
    destinationOperationalAccountId: transfer.destinationOperationalAccountId,
    currencyId: transfer.currencyId,
    currencyCode: transfer.currencyCode ?? null,
    sourceCounterpartyName: transfer.sourceCounterpartyName ?? null,
    destinationCounterpartyName: transfer.destinationCounterpartyName ?? null,
    sourceOperationalAccountLabel:
      transfer.sourceOperationalAccountLabel ?? null,
    destinationOperationalAccountLabel:
      transfer.destinationOperationalAccountLabel ?? null,

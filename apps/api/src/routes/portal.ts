...
import { resolveEffectiveCustomerAgreementByCustomerId } from "./customers-contracts";
...
export function portalRoutes(ctx: AppContext) {
  ...
  const createCounterpartyRoute = createRoute({
    ...
    path: "/counterparties",
    tags: ["Portal"],
    summary: "Create a portal counterparty",
    request: {
      body: {
        content: {
          "application/json": {
  ...
  const parseCardRoute = createRoute({
    ...
    tags: ["Portal"],
    summary: "Parse uploaded portal onboarding card",
    responses: {
      200: {
  ...
  const createDealDraftRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Create typed portal deal draft",
    request: {
      body: {
        content: {
          "application/json": {
  ...
  const listDealProjectionsRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "List portal-safe deal projections",
    request: {
      query: z.object({
        limit: z.coerce.number().int().default(20),
        offset: z.coerce.number().int().default(0),
  ...
  const getDealRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Get portal deal detail",
  ...
  const getDealProjectionRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Get portal-safe deal projection",
    request: { params: CustomerPortalDealIdParamSchema },
    responses: {
      200: {
        content: {
  ...
  const listDealAttachmentsRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "List portal-safe deal attachments",
    request: { params: CustomerPortalDealIdParamSchema },
    responses: {
      200: {
        content: {
        ...
        description: "Portal-safe deal attachments",
      },
      403: {
        content: { "application/json": { schema: z.object({ error: z.string() }) } },
        description: "Not authorized",
  ...
  const uploadDealAttachmentRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Upload a portal-safe deal attachment",
    request: { params: CustomerPortalDealIdParamSchema },
    responses: {
      201: {
        content: {
  ...
  const downloadDealAttachmentRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Download a portal-safe deal attachment",
  ...
  const deleteDealAttachmentRoute = createRoute({
    ...
    tags: ["Portal"],
    middleware: [requireCustomerPortalAccess(ctx)],
    summary: "Delete a portal-safe deal attachment",
    request: { params: CustomerPortalDealAttachmentParamsSchema },
    responses: {
      200: {
        content: {

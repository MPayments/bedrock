...
import type { DealPricingCommitWorkflow } from "./composition/deal-pricing-commit-workflow";
...
export function createAppContext(env: Env): AppContext {
  ...
  return {
    ...
    createDocumentsService: applicationServices.createDocumentsService,
    createLedgerModule: applicationServices.createLedgerModule,
    ...
    dealPricingCommitWorkflow: applicationServices.dealPricingCommitWorkflow,

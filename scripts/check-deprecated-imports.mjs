...
const LEGACY_SPECIFIER_PATTERN =
  /@bedrock\/(foundation|platform|modules|core|application|kernel|accounting|balances|component-runtime|module-runtime|connectors|dimensions|documents|idempotency|ledger|orchestration|reconciliation|currencies|counterparties|customers|counterparty-accounts|accounting-reporting|fees|fx|payments)(?:\/|["'])/g;

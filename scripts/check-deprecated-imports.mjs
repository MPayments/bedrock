...
const LEGACY_SPECIFIER_PATTERN =
  /@bedrock\/(?:platform-[^"'/]+(?:\/|["'])|(?:core|money|reference-data)(?:\/|["'])|(?:application|runtime|modules)(?:\/|["'])|(?:(adapter|integration|extension)-[^"'/]+)|(?:party-types|query-accounting-reporting|observability|persistence|identity|client-api|ui)(?:\/|["'])|organizations\/validation(?:\/|["'])|balances\/validation(?:\/|["'])|documents\/(?:module-kit|financial-lines|validation|state-machine|form-types)(?:\/|["'])|ledger\/infra\/tigerbeetle(?:\/|["']))/g;
